---
title: Tailwind CSS Empty States
description: Beautiful, modern empty state component for Tailwind CSS. Use it to say there is nothing to show yet, like an empty list or no results. Easily customizable.
---

Use the empty component to tell users there is nothing to show yet, like an empty list, zero search results, or a first-run screen. For a placeholder while content loads, reach for the [skeleton](/components/skeleton).

```html preview preset=base
<div class="empty w-full max-w-2xl">
...
### Outlined empty state

Add `border border-dashed` for a dashed outline around the empty state.

```html preview preset=base
<div class="empty w-full max-w-2xl border border-dashed">
  <div class="empty-header">
    <div class="empty-media empty-media-icon">
...
### Empty state with a background

Give the empty state a muted background to set it apart from the page.

```html preview preset=base
<div class="empty h-full w-full max-w-2xl bg-muted/30">
  <div class="empty-header">
    <div class="empty-media empty-media-icon">
...
### Empty state with an avatar group

A stacked [avatar group](/components/avatar#avatar-group) in the media slot.
...
<div id="empty-rtl-demo" dir="rtl" class="empty w-full max-w-2xl">
  <div class="empty-header">
    <div class="empty-media empty-media-icon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 10.5 8 13l2 2.5"/><path d="m14 10.5 2 2.5-2 2.5"/><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2z"/></svg>
    </div>
