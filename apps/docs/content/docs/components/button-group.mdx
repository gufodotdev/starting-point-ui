...
A Tailwind CSS button group component for grouping related [buttons](/components/button) together.
...
Button groups work with all [button sizes](/components/button#sizes).
