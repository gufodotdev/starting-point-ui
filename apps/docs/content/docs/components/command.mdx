...
<div class="command max-w-sm rounded-lg border">
  ...
  <div class="command-list">
    ...
    <div class="command-group">
      ...
      <button class="command-item" data-sp-highlighted>
...
<div class="command">
  ...
  <div class="command-list">
    <div class="command-empty">No results found.</div>
    <button class="command-item" data-sp-highlighted>Calendar</button>
  </div>
</div>
```
...
<div class="command max-w-sm rounded-lg border">
  ...
  <div class="command-list">
    ...
    <div class="command-group">
      ...
      <button class="command-item" data-sp-highlighted>New File</button>
