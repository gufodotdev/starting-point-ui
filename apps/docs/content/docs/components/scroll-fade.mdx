---
title: Tailwind CSS Scroll Fade
description: Beautiful, modern scroll fade utility for Tailwind CSS. Use it to fade scrollable content at its edges, like a long list or a chat feed. Easily customizable.
---

Use the scroll fade utility to mask the edges of a scroller so content fades out instead of clipping, like in a long list, a chat feed, or a horizontal row of tags. For styling the scrollbar itself, use the [scrollbar](/components/scrollbar) utility.
...
| `--scroll-fade-mask`   | The built-in gradient                 | The mask itself, set to `none` to disable               |
