---
title: Tailwind CSS Toggle Switch
description: Beautiful, modern toggle switch component for Tailwind CSS. Use it to turn a setting on or off, like notifications or dark mode. Easily customizable.
---

Use the switch component to turn a setting on or off with immediate effect, like notifications or dark mode. For options that are submitted with a form, reach for the [checkbox](/components/checkbox).
