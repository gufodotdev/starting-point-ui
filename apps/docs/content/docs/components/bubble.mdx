---
title: Tailwind CSS Chat Bubble
description: Beautiful, modern chat bubble component for Tailwind CSS. Use it to show chat messages, like in a messaging app or an AI assistant. Easily customizable.
---

Use the bubble component to draw one speech balloon of a chat, like in a messaging app or an AI assistant. Place bubbles inside [message](/components/message) rows to build the conversation.
