---
title: Input
description: An input component for Tailwind CSS with beautiful shadcn/ui styling. Use it to capture single-line text like names, emails, and search queries.
---

The input captures a single line of text, from names and emails to search queries. Pair it with a [field](/components/field) for a label and description; for multi-line text, reach for the [textarea](/components/textarea).
