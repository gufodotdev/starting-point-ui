---
title: Tailwind CSS Table
description: Beautiful, modern table component for Tailwind CSS. Use it to present tabular data, like invoices, users, or transactions. Easily customizable.
---

Use the table component to present tabular data on native table elements, like invoices, users, or transactions. For selecting rows, pair it with a [checkbox](/components/checkbox), and for per-row actions, a [dropdown](/components/dropdown).
...
End rows with a [dropdown](/components/dropdown) of row actions, like in the [table row actions](/examples/dropdowns/table-row-actions) example.
