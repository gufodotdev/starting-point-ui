...
description: Beautiful, modern card component for Tailwind CSS. Use it to group related content on one surface, like a login form or a stat. Easily customizable.
---

Use the card component to group related content on one surface, like a login form, a stat, or a settings section. For a single row with media, text, and actions, use an [item](/components/item).
...
| Class              | Description                                                       |
| ------------------ | ----------------------------------------------------------------- |
| `card`             | Add to the surface, spaced by `--card-spacing`                    |
