---
title: Tailwind CSS Form Field
description: Beautiful, modern form field component for Tailwind CSS. Use it to lay out a control with its label, like an input or a checkbox. Easily customizable.
---

Use the field component to wrap a form control with its label, description, and error message, like an [input](/components/input), a [select](/components/select), or a checkbox. For complete forms built from fields, see the [forms](/components/forms) page.
...
| `field-separator`                     | Add to a divider between fields, with optional text in a `<span>`             |
...
Stack the label, control, and description in any order and the field spaces them.
...
A [textarea](/components/textarea) works like any other control.
