---
title: Badge
description: A badge component for Tailwind CSS with beautiful shadcn/ui styling. Use it to mark content with a small status or label, like "New", a count, or a category.
---
...
| Class               | Description                                               |
| ------------------- | --------------------------------------------------------- |
| `badge`             | Add to the element; primary style by default              |
