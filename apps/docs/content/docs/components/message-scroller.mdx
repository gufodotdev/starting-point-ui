...
description: A message scroller component for Tailwind CSS with beautiful shadcn/ui styling. Use it to build chat feeds that follow new messages and keep the reader's place.
---

The message scroller is the scrolling viewport of a chat: it follows new messages as they arrive, pins fresh turns to the top like an AI assistant, and keeps the reader's place when older history loads in. Use it around [message](/components/message) rows for messaging UIs and AI chats.
