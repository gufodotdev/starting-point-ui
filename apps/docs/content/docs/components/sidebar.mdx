...
You can also use both at once, e.g. a navigation panel on the left and a table of contents on the right. Put two panels in the same `sidebar-layout`, each with its own trigger, and they collapse independently.

```html
<div class="sidebar-layout">

  <!-- Left navigation -->
  <aside class="sidebar sidebar-left" data-sp-toggle="#nav-trigger">...</aside>
  ...
  <aside class="sidebar sidebar-right" data-sp-toggle="#toc-trigger">...</aside>
</div>
```
