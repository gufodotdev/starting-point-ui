---
title: Sidebar
description: A sidebar component for Tailwind CSS with beautiful shadcn/ui styling. Use it to put app navigation beside the page, collapsing to an icon rail or a mobile drawer.
---
...
A sidebar defaults to the start side, the left in LTR. Add `sidebar-end` to move it to the other side; `sidebar-left` and `sidebar-right` pin a physical edge.
