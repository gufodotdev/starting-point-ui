---
title: Tailwind CSS Chat Marker
description: Beautiful, modern chat marker component for Tailwind CSS. Use it for the lines between chat messages, like a date divider or a status. Easily customizable.
---

Use the marker component for the small line between chat messages, like a status update, a date divider, or an activity note. Place markers between [message](/components/message) rows to build the conversation.
...
| `marker-icon`                    | Add to the decorative icon element, with `aria-hidden`   |
...
<div id="marker-rtl-demo" dir="rtl" class="flex w-full max-w-sm flex-col gap-6">
  <div class="marker marker-separator">
