---
title: Customization
description: Learn how to theme and customize Starting Point UI components with CSS variables for colors, radius, and fonts, utility classes, and your own CSS.
---
