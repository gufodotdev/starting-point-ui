---
title: Right-to-left (RTL) support for Tailwind CSS components
description: Every Tailwind CSS component mirrors automatically for right-to-left languages like Arabic and Hebrew, with nothing to install or configure.
---
...
<div id="card-rtl-demo" class="w-full max-w-sm" dir="rtl">
  <div class="card">
