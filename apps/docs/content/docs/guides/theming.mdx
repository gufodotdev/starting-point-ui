...
The library uses two font variables applied in the base layer:

- `--font-body` — applied to `body`, used for all text by default
- `--font-heading` — applied to `h1` through `h6`
