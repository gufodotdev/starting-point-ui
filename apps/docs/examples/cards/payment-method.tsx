export default function PaymentMethod() {
  return (
    <div className="card">
      ...
      <div className="card-content grid grid-cols-3 gap-3" role="radiogroup" aria-label="Payment method">
        <label className="label">
          <div className="field items-center gap-2 text-center">
            <input
              type="radio"
              className="sr-only"
              name="payment"
      ...
      <form className="card-content field-group">
        ...
        <div className="field">
          <label className="label" htmlFor="pay-number">
            Card Number
          </label>
          <input
            className="input"
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="field">
            <label className="label" htmlFor="pay-month">
              Month
            </label>
            <input
              className="input"
          ...
          <div className="field">
            <label className="label" htmlFor="pay-year">
              Year
            </label>
            <input
              className="input"
          ...
          <div className="field">
            <label className="label" htmlFor="pay-cvv">
              CVV
            </label>
            <input
              className="input"
