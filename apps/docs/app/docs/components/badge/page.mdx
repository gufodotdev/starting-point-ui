...
<button class="btn btn-outline btn-icon relative" aria-label="Notifications">
  <icon-bell />
  <span class="badge badge-destructive absolute -top-1 -right-1 size-5 p-0">3</span>
</button>
...
<span class="badge bg-green-500/10 text-green-500 border-transparent">Success</span>
<span class="badge bg-yellow-500/10 text-yellow-500 border-transparent">Warning</span>
