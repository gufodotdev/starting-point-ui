  ...
  <table class="table">
    ...
    <tbody class="table-body">
      <tr class="table-row">
        ...
        <td class="table-cell">
          <span
            class="inline-flex items-center rounded-full bg-green-500/10 px-2 py-1 text-xs font-medium text-green-500"
            >Delivered</span
          >
        </td>
      ...
      <tr class="table-row">
        ...
        <td class="table-cell">
          <span
            class="inline-flex items-center rounded-full bg-yellow-500/10 px-2 py-1 text-xs font-medium text-yellow-500"
            >Shipping</span
          >
        </td>
      ...
      <tr class="table-row">
        ...
        <td class="table-cell">
          <span
            class="inline-flex items-center rounded-full bg-red-500/10 px-2 py-1 text-xs font-medium text-red-500"
            >Cancelled</span
          >
        </td>
  ...
  <table class="table">
    ...
    <tbody class="table-body">
      <tr class="table-row">
        <td class="table-cell">
          <div class="flex items-center gap-3">
            <icon-folder class="size-4 text-blue-400 fill-blue-400" />
      ...
      <tr class="table-row">
        <td class="table-cell">
          <div class="flex items-center gap-3">
            <icon-file class="size-4 text-muted-foreground" />
            <a href="#" class="hover:underline hover:text-blue-500"
              >.gitignore</a
            >
          </div>
...
| -------------- | ------- | -------------------------- |
| `table`        | `table` | Base table styles          |
| `table-header` | `thead` | Table header section       |
| `table-body`   | `tbody` | Table body section         |
| `table-footer` | `tfoot` | Table footer section       |
| `table-row`    | `tr`    | Table row with hover state |
| `table-head`   | `th`    | Table header cell          |
| `table-cell`   | `td`    | Table data cell            |
