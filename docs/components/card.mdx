...
<div class="card w-full max-w-sm">
  ...
  <div class="card-content">
    ...
    <p class="text-sm/6 text-muted-foreground mt-2">
      Learn how utility classes can help you build and scale a beautiful design
    ...
    <div class="flex items-center gap-3 mt-6">
      ...
      <div class="grid gap-1.5">
        ...
        <span class="text-xs/none text-muted-foreground font-medium"
...
<div class="grid gap-6 w-full max-w-sm">
  ...
  <div class="card">
    <div class="card-content sm:p-12 grid gap-6">
