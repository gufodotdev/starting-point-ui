...
```html preview
<button class="btn btn-outline" data-sp-toggle="dialog" data-sp-target="#sheet-simple">
  Open Simple Sheet
</button>
<dialog id="sheet-simple" class="dialog" aria-labelledby="sheet-simple-title" aria-describedby="sheet-simple-desc">
  <div class="sheet-backdrop"></div>
  <div class="sheet-panel">
    <div class="sheet-content">
      <button class="btn btn-ghost btn-icon-sm absolute top-4 right-4" aria-label="Close" data-sp-dismiss="dialog">
        <i class="ri-close-line text-xl"></i>
      </button>
      <h2 id="sheet-simple-title" class="text-lg font-semibold">Sheet Title</h2>
      <p id="sheet-simple-desc" class="mt-2 text-sm text-muted-foreground">
        This is a simple sheet that slides in from the left. Click the backdrop or press escape to close.
      </p>
    </div>
  </div>
</dialog>

<button data-sp-toggle="dialog" data-sp-target="#sheet-menu" class="btn btn-outline">
  Open Menu Sheet
</button>
<dialog id="sheet-menu" class="dialog" aria-labelledby="sheet-menu-title">
  <div class="sheet-backdrop"></div>
  <div class="sheet-panel sheet-left">
    <div class="sidebar-content">
      <header class="sidebar-header">
        <div class="menu-item menu-item-lg justify-between">
...
If you're building a navigation menu, you might prefer using the [Sidebar](/docs/components/sidebar) utilities instead of the sheet utilities, which works just as well. The menu example above uses sidebar utilities while the simple sheet uses sheet utilities.
...
>
  <div class="sheet-panel">
    <div class="sheet-content">
      <h2 id="sheet-nonmodal-title" class="text-lg font-semibold mb-2">
        Non-modal
      </h2>
...
>
  ...
  <div class="sheet-panel sheet-bottom">
    <div class="sheet-content">
      <div class="flex items-center justify-between">
        <h2 id="sheet-bottom-title" class="text-lg font-semibold">
          Bottom Sheet
        </h2>
        <button
          class="btn btn-ghost btn-icon"
...
>
  ...
  <div class="sheet-panel sheet-right">
    <div class="sheet-content">
      <h2 id="sheet-static-title" class="text-lg font-semibold mb-2">
        Are you sure?
      </h2>
