...
<form class="grid gap-8 max-w-sm">
  ...
  <div class="grid gap-3">
    ...
    <textarea
      class="textarea"
      id="details"
      placeholder="Tell us about your event, dietary requirements, venue details..."
    ></textarea>
  </div>
  <div class="grid gap-3">
    ...
    <div class="grid gap-3">
      <div class="flex items-center gap-2">
        <input class="radio" type="radio" name="payment" id="card" checked />
      ...
      <div class="flex items-center gap-2">
        ...
        <label class="label" for="bank">Bank transfer</label>
      </div>
    </div>
  </div>
  <div class="flex items-center gap-2">
    ...
    <label class="label" for="newsletter"
      >Send me news and special offers</label
    >
  </div>
  <div class="flex items-center gap-2">
    <input class="switch" type="checkbox" id="notifications" role="switch" />
...
<div class="grid gap-6 w-full max-w-sm">
  ...
  <div class="input-group">
    ...
    <span class="input-group-addon"><icon-check /></span>
  </div>
  <div class="input-group">
