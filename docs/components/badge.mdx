...
```html preview
<span class="badge"><i class="ri-check-fill"></i> Verified</span>
<span class="badge badge-secondary"><i class="ri-time-line"></i> Pending</span>
<span class="badge badge-destructive"><i class="ri-close-fill"></i> Failed</span>
<span class="badge badge-outline"><i class="ri-star-s-line"></i> Featured</span>
```
