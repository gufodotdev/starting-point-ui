...
<dialog
  ...
  aria-describedby="dialog-3-desc"
>
    ...
    <div class="dialog-content">
      ...
      <div class="grid gap-6">
        <div>
          ...
          <p id="dialog-3-desc" class="mt-2 text-sm/6 text-muted-foreground">
            This is a modal dialog. Close it by clicking the backdrop, pressing
            escape, or using the close button.
          </p>
        </div>
        <div class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          <button class="btn btn-outline" data-sp-dismiss="dialog">
            Cancel
          </button>
...
```html preview
<button data-sp-toggle="dialog" data-sp-target="#dialog-4" class="btn">
  Open Dialog
</button>
...
<dialog
  ...
  aria-describedby="dialog-4-desc"
>
  <div class="dialog-backdrop"></div>
  <div class="dialog-panel">
    <div class="dialog-content">
      <div class="grid gap-6">
        <div>
          ...
          <p id="dialog-4-desc" class="mt-2 text-sm/6 text-muted-foreground">
